...
parser.add_argument("--audio_in",
                    type=str,
                    default=r'D:\Python_workspace\image-element-positioning\tools\inputs\recording.wav',
                    help="audio_in")
...
parser.add_argument("--output_dir",
                    type=str,
                    default=r'D:\Python_workspace\image-element-positioning\tools\outputs',
                    help="output_dir")
...
async def record_microphone():
    ...
    CHANNELS = 1
    RATE = 16000
    chunk_size1 = 60 * 10 / args.chunk_interval
    ...
    message = json.dumps({"mode": args.mode, "chunk_size": chunk_size, "chunk_interval": args.chunk_interval,
...
async def record_from_scp(chunk_begin, chunk_size):
    ...
    for wav in wavs:
        ...
        stride = int(60 * 10 / args.chunk_interval / 1000 * sample_rate * 2)
        ...
        for i in range(chunk_num):
            ...
            sleep_duration = 0.001 if args.mode == "offline" else 60 * chunk_size[1] / args.chunk_interval / 1000
